 ...
 * 
 */
@WebServiceClient(name = "FilmeFacadeService", targetNamespace = "http://soap.filmes.argonavis.com/", wsdlLocation = "http://helders-macbook-pro.local:8080/FilmesServiceSoap/FilmeFacadeService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://helders-macbook-pro.local:8080/FilmesServiceSoap/FilmeFacadeService?wsdl");
